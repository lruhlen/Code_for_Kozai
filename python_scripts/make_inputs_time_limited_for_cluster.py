...
#============================================================
def make_input_files_time_limited():
    ...
    for mass in mass_record:
        ...
        for tKozai in tKozai_vals:
            ...
            tmax_string = str('{:.2E} '.format(tmax))
            tmax_string = ' TMAX= {:>9}'.format(tmax_string)
            twrt_string = str('{:.2E} '.format(twrt))
            twrt_string = 'TWRT= {:>9} '.format(twrt_string)
            twrt_string = twrt_string+' \n'
            time_info_string = tmax_string+twrt_string
            #            print time_info_string
            ...
            for ecc in ecc_vals:
                ...
                for semi in semi_vals:
                    ...
                    outfile.write(time_info_string)
                    outfile.write(block_four)
                    outfile.close()


#                    print '\n\n',start_model_string,input_file_path_string,moda_string,nmod_string,nrit_string,block_one,tK_string,block_two,ecc_string,semi_string,block_three,time_info_string,block_four 
